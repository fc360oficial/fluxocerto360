  ...
  try {
    const [rows] = await conn.query(`
      SELECT i.Codigo, i.Descricao,
        ...
        COALESCE(e1.Estoque,0) AS L1, COALESCE(e2.Estoque,0) AS L2,
        COALESCE(e3.Estoque,0) AS L3, COALESCE(e4.Estoque,0) AS L4,
        COALESCE(e5.Estoque,0) AS L5, COALESCE(e6.Estoque,0) AS L6
      ...
      WHERE i.CodDesativado=0 AND i.Descricao NOT LIKE '% KG%'
        AND (COALESCE(e1.Estoque,0)<0 OR COALESCE(e2.Estoque,0)<0 OR
             COALESCE(e3.Estoque,0)<0 OR COALESCE(e4.Estoque,0)<0 OR
             COALESCE(e5.Estoque,0)<0 OR COALESCE(e6.Estoque,0)<0)
