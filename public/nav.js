...
(function () {
  ...
  +   'background:var(--crd,#FFFFFF);border-right:1px solid var(--ln,#D8D9CF);'
  ...
  +   'border-bottom:1px solid var(--ln,#D8D9CF);margin-bottom:10px;text-decoration:none}'
  ...
  + '#dsnav a.dn-item:hover{background:var(--wsh,#E2E3DA);color:var(--ink,#0E1626)}'
  + '#dsnav a.dn-item.on{background:var(--amw,#FFF6D9);color:var(--amk,#6B4E00)}'
  + '#dsnav a.dn-item.on svg{color:var(--amk,#6B4E00)}'
  + '#dsnav .dn-foot{margin-top:auto;border-top:1px solid var(--ln,#D8D9CF);padding-top:10px;'
  ...
  +     'border-right:none;border-bottom:1px solid var(--ln,#D8D9CF)}'
