...
(function (root, factory) {
  ...
  function calcularResultado(cat, bips, resolucoes) {
    ...
    function mk(k, it, cont, nc) {
      ...
      return { key: k, codigo: it.c || '', ean: it.e || '', desc: it.d || '', un: it.u || '', sistema: sis, contado: cont, dif: dif, custo: custo, valor: (dif != null && custo != null) ? dif * custo : null, nc: !!nc, bips: nBips[k] || 0, ends: endsPor[k] ? Object.keys(endsPor[k]).length : 0 };
    }
    var linhas = [], vistos = {};
